...
export default function Content() {
    ...
    useEffect(() => {
        fetch('https://antopolis.antapp.space/api/category-related-services/3')
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch('https://antopolis.antapp.space/api/portfolio-category-by-level/3')
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch('https://antopolis.antapp.space/api/portfolio-items/3')
            .then(res => res.json())
                                ...
                                >
                                    {pclients.map((slide, index) =>
                                        <div className="slick-slide-content" key={index}>
                                            <img className="slick-slide-image" src={`https://antopolis.antapp.space/` + slide.image} alt={slide.name} />
